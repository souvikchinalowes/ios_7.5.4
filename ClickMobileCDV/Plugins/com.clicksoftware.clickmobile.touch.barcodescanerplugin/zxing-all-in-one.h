 ...
 *  zxing
 *
 *  Copyright 2010 ZXing authors All rights reserved.object *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at
 *
...
namespace zxing {
  ...
  public:
    MultiFormatReader();
      ...
      Ref<Result> decode(Ref<BinaryBitmap> image, const char* formats /*Rotem - barcode format*/);
      Ref<Result> decode(Ref<BinaryBitmap> image, DecodeHints hints);
      Ref<Result> decode(Ref<BinaryBitmap> image, DecodeHints hints, const char* formats /*Rotem - barcode format*/);
      Ref<Result> decodeWithState(Ref<BinaryBitmap> image, const char* formats /*Rotem - barcode format*/);
      void setHints(DecodeHints hints, const char* formats /*Rotem - barcode format*/);
      ~MultiFormatReader();
...
namespace zxing {
  namespace oned {
    ...
    public:
      MultiFormatOneDReader(DecodeHints hints, const char* formats /*Rotem - barcode format*/);
